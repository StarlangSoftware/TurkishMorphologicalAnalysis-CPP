...
TEST_CASE("TransitionTest-testNumberWithDative") {
    FsmMorphologicalAnalyzer fsm = FsmMorphologicalAnalyzer();
...
TEST_CASE("TransitionTest-testPresentTense") {
    FsmMorphologicalAnalyzer fsm = FsmMorphologicalAnalyzer();
...
TEST_CASE("TransitionTest-testA") {
    FsmMorphologicalAnalyzer fsm = FsmMorphologicalAnalyzer();
...
TEST_CASE("TransitionTest-testC") {
    FsmMorphologicalAnalyzer fsm = FsmMorphologicalAnalyzer();
...
TEST_CASE("TransitionTest-testSH") {
    FsmMorphologicalAnalyzer fsm = FsmMorphologicalAnalyzer();
...
TEST_CASE("TransitionTest-testNumberWithD") {
    FsmMorphologicalAnalyzer fsm = FsmMorphologicalAnalyzer();
...
TEST_CASE("TransitionTest-testD") {
    FsmMorphologicalAnalyzer fsm = FsmMorphologicalAnalyzer();
...
TEST_CASE("TransitionTest-testLastIdropsDuringSuffixation") {
    FsmMorphologicalAnalyzer fsm = FsmMorphologicalAnalyzer();
...
TEST_CASE("TransitionTest-testNounSoftenDuringSuffixation") {
    FsmMorphologicalAnalyzer fsm = FsmMorphologicalAnalyzer();
...
TEST_CASE("TransitionTest-testVerbSoftenDuringSuffixation") {
    FsmMorphologicalAnalyzer fsm = FsmMorphologicalAnalyzer();
