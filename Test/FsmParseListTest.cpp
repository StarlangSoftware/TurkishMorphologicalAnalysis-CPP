...
TEST_CASE("FsmParseListTest") {
    ...
    SECTION("FsmParseListTest-testRootWords") {
        parse1 = fsm.morphologicalAnalysis("açılır");
        parse2 = fsm.morphologicalAnalysis("koparılarak");
        parse3 = fsm.morphologicalAnalysis("toplama");
        parse4 = fsm.morphologicalAnalysis("değerlendirmede");
    ...
    SECTION("FsmParseListTest-testGetParseWithLongestRootWord") {
        parse2 = fsm.morphologicalAnalysis("koparılarak");
        parse3 = fsm.morphologicalAnalysis("toplama");
        parse4 = fsm.morphologicalAnalysis("değerlendirmede");
        parse5 = fsm.morphologicalAnalysis("soruşturmasının");
    ...
    SECTION("FsmParseListTest-testReduceToParsesWithSameRootAndPos") {
        parse2 = fsm.morphologicalAnalysis("koparılarak");
        parse3 = fsm.morphologicalAnalysis("toplama");
        parse6 = fsm.morphologicalAnalysis("karşılaştırmalı");
    ...
    SECTION("FsmParseListTest-testReduceToParsesWithSameRoot") {
        parse2 = fsm.morphologicalAnalysis("koparılarak");
        parse3 = fsm.morphologicalAnalysis("toplama");
        parse6 = fsm.morphologicalAnalysis("karşılaştırmalı");
        parse7 = fsm.morphologicalAnalysis("esaslarını");
    ...
    SECTION("FsmParseListTest-testConstructParseListForDifferentRootWithPos") {
        parse1 = fsm.morphologicalAnalysis("açılır");
        parse2 = fsm.morphologicalAnalysis("koparılarak");
        parse3 = fsm.morphologicalAnalysis("toplama");
        parse4 = fsm.morphologicalAnalysis("değerlendirmede");
    ...
    SECTION("FsmParseListTest-testParsesWithoutPrefixAndSuffix") {
