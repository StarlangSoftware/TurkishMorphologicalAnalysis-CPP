...
#ifndef MORPHOLOGICALANALYSIS_MORPHOLOGICALTAG_H
#define MORPHOLOGICALANALYSIS_MORPHOLOGICALTAG_H


enum class MorphologicalTag {
    /**
     * Noun : Alengir
     */
            NOUN,
...
#endif //MORPHOLOGICALANALYSIS_MORPHOLOGICALTAG_H
